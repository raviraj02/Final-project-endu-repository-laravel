...
// Orders
Route::get('/orders', [App\Http\Controllers\OrderController::class, 'ordersShowad'])->name('orders.index')->middleware('auth');
Route::post('/update-status/{id}', [App\Http\Controllers\OrderController::class, 'status'])->name('edit-status')->middleware('auth');;
